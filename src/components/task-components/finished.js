...
function Finished({ onTaskClick }) {
    ...
    useEffect(() => {
        function getData() {
            let readyTask = getTasksByType('finished');
    ...
    const backlogTasks = getTasksByType('inProgress');
    ...
    return (
        <div className="task__component__div finished">
            <h1>Finished</h1>
            <div className="task__component__div__container task__component__div__container--finished">
                {Tasks.map((task) => (
